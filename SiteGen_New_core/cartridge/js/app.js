...
/*
	...
	Sandbox
	http(s)://<sub_domain>.demandware.net/s/<site_id>/dw/<api_typ
	e>/
	Example
	http://ajones.insidena02.
	dw.demandware.net/s/SiteGenesis/dw/shop

	https://demo-store-vsp.demandware.net/s/eyeconic/dw/shop/v15_6/baskets/cdxbsiaajekPUaaado1kQh0aGM?client_id=aaaaaaaaaaaaaaaaaaaaaaaaaaaaaa&method=patch
*/
// initialize app
