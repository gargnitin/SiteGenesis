...
var CartModel = AbstractModel.extend({
    ...
    addBonusProduct: function (bonusDiscountLineItem, product, selectedOptions) {
        ...
        var UpdateProductOptionSelections = require('SiteGen_New_core/cartridge/scripts/cart/UpdateProductOptionSelections');
    ...
    validateForCheckout: function () {
        var ValidateCartForCheckout = require('SiteGen_New_core/cartridge/scripts/cart/ValidateCartForCheckout');
